...
#ifdef	SDCC_mcs51
#ifndef	DEFINE_AT
#define DEFINE_AT(TYPE, NAME, ADDRESS, MEMORY)		MEMORY __at (ADDRESS) TYPE NAME
...
#ifndef	bInLen
#define bInLen							(*(BYTE __xdata *)0x0800)					/* length of the inputted data							*/
//!//#define bInLen							(*(BYTE xdata *)0x0800)					/* length of the inputted data							*/
#endif

#ifndef pbInBuff
#define	pbInBuff						((BYTE __xdata *)0x0801)					/* inputted data											*/
